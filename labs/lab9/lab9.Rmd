...
We will use ridge regression and the lasso to estimate the salary of various baseball players based on several predictor measurements. This data set is taken from the *ISLR* package. Download the file *hitters.Rdata* at http://bsouhaib.github.io/BusinessAnalytics/labs/hitters.Rdata. We will use the implementation of these algorithms available in the *glmnet* package.
...
Download the file *hitters.Rdata* from https://github.com/bsouhaib/BA2017/blob/master/data/hitters.rdata.
